...
namespace GameMemento.Session
{
    ...
    public class GameMemory
    {
        ...
        /// </summary>
        private GameMemory() {
            Checkpoints = new List<IPublicMemento>();
        }
        #endregion
        ...
        /// </summary>
        private List<IPublicMemento> Checkpoints { get; set; }
        ...
        public IPublicMemento GetLastCheckpoint()
        {
        ...
        /// <returns>Memento.</returns>
        public IPublicMemento GetCheckpoint(int index)
        {
